...
public class FrmUsuario extends javax.swing.JInternalFrame {
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtTelefono, javax.swing.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cboRol, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {                                           
            ...
            if (this.accion.equals("editar")) {
               ...
               resp = this.CONTROL.actualizar(Integer.parseInt(txtId.getText()), seleccionado.getId(), txtNombre.getText(),(String)cboTiPoDNI.getSelectedItem(), txtNumDocumento.getText(), txtDireccion.getText(), txtTelefono.getText(), txtEmail.getText(), this.emailAnt, txtPassword.getText() );
                ...
                resp = this.CONTROL.insertar( seleccionado.getId(), txtNombre.getText(),(String)cboTiPoDNI.getSelectedItem(), txtNumDocumento.getText(), txtDireccion.getText(), txtTelefono.getText(), txtEmail.getText(), txtPassword.getText() );
                if (resp.equals("OK")) {                 
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        if (tablaListado.getSelectedRowCount() == 1) {
                ...
                String tipoDNI = String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(), 4));
                ...
                String password = String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(), 9));

                txtId.setText(id);
                Rol item = new Rol(rolId, rolNombre);
                cboRol.setSelectedItem(item);              
